    ...
    item.addEventListener('click', function() {
        ...
        switch(page) {
            ...
            case 'tentang kami':
                ...
                break;
            case 'rating ezydraw':
                alert('Fitur rating akan datang!');
                return;
            case 'pusat bantuan':
...
document.querySelector('.btn-new-design').addEventListener('click', function() {
    alert('Fitur "Buat Desain Baru" akan membuka editor baru. Fitur ini masih dalam pengembangan!');
});
...
printStyles.textContent = `
    @media print {
        ...
        .team-member, .feature-card, .solution-card {
            break-inside: avoid;
